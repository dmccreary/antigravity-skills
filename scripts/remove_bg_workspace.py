...
def process(input_filename, output_filename):
    ...
    brain_dir = os.path.join(home, ".gemini", "antigravity", "brain", "331be46c-d582-43d8-83b7-41d827124aa8")
    input_path = os.path.join(brain_dir, input_filename)
    
    workspace_dir = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
    output_dir = os.path.join(workspace_dir, "img", "capybara")
...
if __name__ == "__main__":
    if len(sys.argv) != 3:
        print("Usage: python remove_bg_workspace.py <input_filename> <output_filename>")
        sys.exit(1)
